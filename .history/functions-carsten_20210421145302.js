...
function lifetimeSupply(age, amountPerDay) {
  ...
  let calculate = Math.ceil(maxAge - age * averageYear * amountPerDay);
  return `The snack company should provide you with ${calculate} units, until you are a ripe old age if ${maxAge}. Happy snacking!`;
}
