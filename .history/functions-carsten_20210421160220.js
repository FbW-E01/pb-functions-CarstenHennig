...
function isWaldoHere(foundAnimal) {
  foundAnimal = foundAnimal.toLowerCase();
  if (foundAnimal.includes("waldo")) {
    return true;
  } else {
    return false;
  }
...
function pie(numberOfSlices, recipients, totalRecipients) {
  if (recipients * totalRecipients > numberOfSlices) {
    return false;
  } else {
    return true;
  }
...
console.log("It's: " + pie(11, 5, 3));
console.log("It's: " + pie(8, 3, 2));
console.log("It's: " + pie(8, 3, 3));
console.log("It's: " + pie(24, 12, 2));
...
console.log(countXO("ooxx"));
console.log(countXO("xooxx"));
console.log(countXO("ooxXm"));
console.log(countXO("zpzpzpp"));
console.log(countXO("zzoo"));
...
// **12. isPrime?**
// Create a function that returns true if a number is a prime number,
// and false if it's not. **NB:** a prime number is any positive integer *greater than 1*,
...
// function checkPrime(maxNumero) {
//   for (var i = 2; i <= maxNumero; i++) {
//     if (maxNumero % i === 0) {
...
function checkPrime(maxNumero) {
  for (var i = 2; i <= maxNumero; i++) {
    if (maxNumero % i === 0) return false;
  }
  return maxNumero > 1;
}

console.log("Task 12", checkPrime(7));
console.log("Task 12", checkPrime(9));
console.log("Task 12", checkPrime(10));
